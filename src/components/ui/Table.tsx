...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('border-b border-white/10 bg-white/5', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn('h-12 px-4 text-left align-middle font-semibold text-white/70 [&:has([role=checkbox])]:pr-0', className)}
    {...props}
  />
))
